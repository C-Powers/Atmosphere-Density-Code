...
clipped_clocky = clocky[clocky[:] <= 9250-8000]
clipped_mean_cps = mean_cps[0:clipped_clocky.size]
m, b = np.polyfit(clipped_clocky, clipped_mean_cps, 1)
print m, b
...
plt.errorbar(clocky, mean_cps, yerr=stdMean_cps,fmt = None,color = "red")
#plt.yscale('log')
plt.xlabel('Time (s)')
